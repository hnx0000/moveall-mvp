...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    diagnosticPass: { backgroundColor: colors.primary },
    diagnosticFail: { backgroundColor: colors.primaryDark },
    diagnosticBlocked: { backgroundColor: colors.muted },
    ...
    diagnosticPassText: { color: colors.primary },
    diagnosticFailText: { color: colors.primaryDark },
    diagnosticBlockedText: { color: colors.muted },
