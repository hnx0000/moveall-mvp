...
import { fonts, radius, shadows, typography, type ThemeColors } from "../../src/theme";
...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    eyebrow: { color: colors.primary, fontSize: 9, fontFamily: fonts.bold, letterSpacing: 1.3 },
    title: {
      color: colors.ink,
      fontSize: 23,
      lineHeight: 29,
    ...
    sportText: { color: colors.muted, fontSize: 10, fontFamily: fonts.semibold },
    ...
    modeLabel: { color: colors.muted, fontSize: 11, fontFamily: fonts.semibold },
    modeLabelActive: { color: colors.ink },
    deck: { gap: 10 },
    deckHeading: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
    deckTitle: { color: colors.ink, fontSize: 14, fontFamily: fonts.bold, letterSpacing: 0.5 },
    ...
    metricValue: { ...typography.numeric(16), color: colors.ink },
    ...
    routeSummary: { borderRadius: radius.xl, backgroundColor: colors.primarySoft, padding: 14 },
    routeSummaryValue: { ...typography.numeric(20), color: colors.primary },
    ...
    emptyDeckText: { color: "#FFFFFF", fontSize: 18, fontFamily: fonts.bold },
    emptyDeckAction: {
    ...
    storyTitle: { color: colors.ink, fontSize: 20, fontFamily: fonts.bold, marginTop: 3 },
