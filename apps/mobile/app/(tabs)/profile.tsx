...
function createStyles(colors: ThemeColors) {
  return StyleSheet.create({
    ...
    adminLink: { color: colors.muted, fontSize: 8, fontWeight: "900", letterSpacing: 1 },
    ...
    displayName: { color: colors.ink, fontSize: 21, fontWeight: "900" },
    editHint: { color: colors.primary, fontSize: 7, fontWeight: "800", marginTop: 2 },
    ...
    nicknameSave: { color: colors.primary, fontSize: 10, fontWeight: "900" },
    avatarMenu: {
      borderWidth: 1,
    ...
    orbCount: { color: colors.muted, fontSize: 15, fontWeight: "900" },
    ...
    medalGlyph: { color: "#FFFFFF", fontSize: 16, fontWeight: "900", fontStyle: "italic" },
    ...
    cardTitle: { color: colors.ink, fontSize: 13, fontWeight: "900", marginTop: 3 },
    recordMetrics: {
      flexDirection: "row",
      alignItems: "baseline",
      justifyContent: "space-between",
    },
    metricStrong: { color: colors.ink, fontSize: 24, fontWeight: "900", letterSpacing: -1 },
    ...
    settingsTitle: { color: colors.ink, fontSize: 12, fontWeight: "900" },
