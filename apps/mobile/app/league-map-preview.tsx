...
const styles = StyleSheet.create({
  ...
  optionButton: { minWidth: 76, height: 62, borderRadius: uiLayout.controlRadius, borderWidth: 1, borderColor: LINE, backgroundColor: PANEL, paddingHorizontal: 12, justifyContent: "center" },
  ...
  mapFrame: { height: 460, borderRadius: uiLayout.panelRadius, overflow: "hidden", borderWidth: 1, borderColor: "#584037", backgroundColor: "#241F1B" },
  mapFrameSplit: { height: 410, borderTopLeftRadius: uiLayout.panelRadius, borderTopRightRadius: uiLayout.panelRadius },
  ...
  focusCard: { position: "absolute", left: 14, bottom: 14, width: 190, padding: 16, borderRadius: uiLayout.panelRadius, backgroundColor: "rgba(12,10,9,.92)", borderWidth: 1, borderColor: "rgba(255,255,255,.2)" },
  ...
  indexCard: { position: "absolute", left: 14, top: 14, minWidth: 150, padding: 12, borderRadius: uiLayout.panelRadius, backgroundColor: "rgba(12,10,9,.9)", flexDirection: "row", alignItems: "center", gap: 10 },
  ...
  topRailItem: { flex: 1, minWidth: 0, height: 78, padding: 10, borderRadius: uiLayout.panelRadius, backgroundColor: PANEL, borderWidth: 1, borderColor: LINE },
  ...
  topFiveLegend: { position: "absolute", left: 14, bottom: 14, paddingHorizontal: 14, paddingVertical: 11, borderRadius: uiLayout.panelRadius, backgroundColor: "rgba(12,10,9,.9)" },
  topFiveCopy: { color: "#FFFFFF", fontFamily: fonts.bold, fontSize: 16, marginTop: 3 },
  lensCard: { position: "absolute", left: 14, right: 14, bottom: 14, minHeight: 68, paddingHorizontal: 14, borderRadius: uiLayout.panelRadius, backgroundColor: "rgba(12,10,9,.92)", borderWidth: 1, borderColor: "rgba(255,255,255,.16)", flexDirection: "row", alignItems: "center", gap: 11 },
  ...
  readabilityRow: { height: 76, marginTop: 12, borderRadius: uiLayout.panelRadius, backgroundColor: PANEL, borderWidth: 1, borderColor: LINE, flexDirection: "row", alignItems: "center" },
  ...
  selectButton: { marginTop: 12, height: 56, borderRadius: uiLayout.controlRadius, borderWidth: 1, borderColor: ORANGE, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 8 },
