...
const _b = StyleSheet.create({
  ...
  version:{color:ORANGE,backgroundColor:"#17100E",borderWidth:1,borderColor:"#643024",borderRadius:16,paddingHorizontal:11,paddingVertical:7,fontFamily:fonts.bold,fontSize:11},
  section:{backgroundColor:PANEL,borderWidth:1,borderColor:LINE,borderRadius:16,padding:14,minWidth:0,overflow:"hidden"},sectionHead:{flexDirection:"row",alignItems:"center",gap:10,marginBottom:15},sectionIndex:{width:36,height:30,borderRadius:9,backgroundColor:ORANGE,color:BLACK,fontFamily:fonts.displayExtra,fontSize:12,textAlign:"center",textAlignVertical:"center",lineHeight:30},sectionHeading:{flex:1},sectionTitle:{color:WHITE,fontFamily:fonts.bold,fontSize:16},sectionSubtitle:{color:"#858E93",fontFamily:fonts.medium,fontSize:12,lineHeight:17,marginTop:3},orange:{color:ORANGE},
  tierShowcase:{minWidth:"100%",gap:10,paddingHorizontal:2,paddingBottom:2},tierShowcaseItem:{width:150,backgroundColor:"#0D1215",borderWidth:1,borderColor:"#242D32",borderRadius:15,padding:12,alignItems:"center",overflow:"hidden"},masterCard:{borderColor:"#713426",backgroundColor:"#110D0B"},tierAccent:{position:"absolute",top:0,left:0,right:0,height:3},tierHeading:{width:"100%",flexDirection:"row",alignItems:"center",gap:8,marginBottom:7},tierRank:{color:"#4F5A60",fontFamily:fonts.displayExtra,fontSize:17},tierName:{color:WHITE,fontFamily:fonts.displayExtra,fontSize:11},tierKo:{color:"#A4ABAF",fontFamily:fonts.medium,fontSize:11,marginTop:2},tierNote:{color:"#B6BEC2",fontFamily:fonts.bold,fontSize:12,marginTop:9},progressTicks:{flexDirection:"row",gap:3,marginTop:8},progressTick:{width:13,height:3,borderRadius:2,backgroundColor:"#263036"},
  ...
  typeGrid:{flexDirection:"row",flexWrap:"wrap",gap:8},typeItem:{width:"47.5%",minWidth:125,backgroundColor:"#0B1013",borderWidth:1,borderColor:"#20282D",borderRadius:13,alignItems:"center",paddingVertical:12,paddingHorizontal:6},typeValue:{color:"#E2E5E6",fontFamily:fonts.bold,fontSize:12,marginTop:7,textAlign:"center"},typeLabel:{color:"#737D82",fontFamily:fonts.medium,fontSize:11,marginTop:3,textAlign:"center"},
  masterRow:{gap:10,paddingHorizontal:2,paddingBottom:2},masterItem:{width:156,backgroundColor:"#0C1012",borderWidth:1,borderColor:"#283138",borderRadius:14,padding:12,alignItems:"center"},masterTop:{width:"100%",flexDirection:"row",justifyContent:"space-between",alignItems:"center",marginBottom:6},masterSport:{color:WHITE,fontFamily:fonts.bold,fontSize:12},masterNumber:{color:"#687277",fontFamily:fonts.displayExtra,fontSize:10},masterCode:{fontFamily:fonts.displayExtra,fontSize:10,letterSpacing:.8,marginTop:9},
  specialRow:{flexDirection:"row",flexWrap:"wrap",gap:10},specialItem:{width:145,minHeight:150,backgroundColor:"#0C1012",borderWidth:1,borderColor:"#2A2421",borderRadius:14,padding:12,alignItems:"center"},specialEdition:{color:ORANGE,opacity:.55,fontFamily:fonts.displayExtra,fontSize:9,letterSpacing:.6,marginTop:5},materialRow:{flexDirection:"row",flexWrap:"wrap",gap:9},materialItem:{alignItems:"center",width:78,backgroundColor:"#0A0E10",borderRadius:12,paddingVertical:10},materialSwatch:{width:52,height:52,borderRadius:26,borderWidth:1,borderColor:"rgba(255,255,255,.3)",padding:5},swatchInner:{flex:1,borderRadius:22,borderWidth:1,borderColor:"rgba(0,0,0,.45)"},materialName:{color:"#BAC0C3",fontFamily:fonts.bold,fontSize:11,marginTop:7},materialCode:{color:"#586268",fontFamily:fonts.displayExtra,fontSize:10,marginTop:2}
});
